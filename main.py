...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '\t         تﻮﻤﻟا فﻭﺮﺣ'))
    print(Colorate.Horizontal(Colors.rainbow, '    تﻮﻤﻟا فﻭﺮﺣ'))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: زيادة المال           1.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{02}: زيادة العملات المعدنية           4.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{03}: رتبة الملك                8.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{04}: تغيير المعرف                4.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{05}: تغيير الاسم              100'))
            print(Colorate.Horizontal(Colors.rainbow, '{06}: تغيير الاسم (قوس قزح)    100'))
            print(Colorate.Horizontal(Colors.rainbow, '{07}: لوحات أرقام السيارات            2.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{08}: حذف الحساب           0'))
            print(Colorate.Horizontal(Colors.rainbow, '{09}: تسجيل الحساب         0'))
            print(Colorate.Horizontal(Colors.rainbow, '{10}: حذف الأصدقاء           500'))
            print(Colorate.Horizontal(Colors.rainbow, '{11}: فتح السيارات المدفوعة         5.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{12}: فتح جميع السيارات          6.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{13}: فتح جميع سيارات صفارات الإنذار    3.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: فتح محرك w16        4.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: فتح جميع الأبواق         3.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: إلغاء قفل تعطيل الضرر    3.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{17}: فتح وقود غير محدود    3.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{18}: فتح المنزل 3           4.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{19}: فتح الدخان             4.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{20}: فتح العجلات            4.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: فتح الرسوم المتحركة        2.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: فتح المعدات م     3.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{23}: فتح المعدات F     3.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{24}: تغيير سباق الفوز         1.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{25}: سباق التغيير يخسر        1.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{26}: استنساخ الحساب            7.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{27}: HP مخصص                2.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{28}: زاوية مخصصة             1.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{29}: حارق إطارات مخصص       1.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{30}: أميال السيارات المخصصة       2.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{31}: فرامل السيارة المخصصة         2.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{0} : خروج'))
