...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, '{08}: حذف الحساب           مجانا'))
            print(Colorate.Horizontal(Colors.yellow_to_red, '{09}: تسجيل الحساب         مجانا'))
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, '{27}:  مخصص محرك                2.500'))
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, '{0} : خروج'))
