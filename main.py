...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.blue_to_red, '\t          👑 ﺕﻮـــﻤــــﻟﺍ ﻑﻭﺮـــﺣ  ﻚــﻤــﻋ  👑'))
...
def prompt_valid_value(content, tag, password=False):
    while True:
        ...
        if not value or value.isspace():
            print(Colorate.Horizontal(Colors.blue_to_red, f'{tag} cannot be empty or just spaces. Please try again.'))
        else:
            return value
    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[?] Enter your new Name.'))
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[?] Enter your new Rainbow Name.'))
                new_name = Prompt.ask("[?] Name")
                console.print("[%] Saving your data: ", end=None)
                if len(new_name) >= 0 and len(new_name) <= 999999999:
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] After deleting your account there is no going back !!.'))
                answ = Prompt.ask("[?] Do You want to Delete this Account ?!", choices=["y", "n"], default="n")
                if answ == "y":
                    cpm.delete()
                    print(Colorate.Horizontal(Colors.blue_to_red, 'ﺢﺟﺎﻧ'))
                    print(Colorate.Horizontal(Colors.blue_to_red, '======================================'))
                    print(Colorate.Horizontal(Colors.blue_to_red, f'Thank You for using our tool, please join our telegram channe: @{__CHANNEL_USERNAME__}.'))
                else: continue
            elif service == 9: # Account Register
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] Registring new Account.'))
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.blue_to_red, 'ﺢﺟﺎﻧ'))
                    print(Colorate.Horizontal(Colors.blue_to_red, '======================================'))
                    print(Colorate.Horizontal(Colors.blue_to_red, f'INFO: In order to tweak this account with CPMElsedev.'))
                    print(Colorate.Horizontal(Colors.blue_to_red, 'you most sign-in to the game using this account.'))
                    sleep(2)
                    continue
                elif status == 105:
                    print(Colorate.Horizontal(Colors.blue_to_red, 'FAILED.'))
                    print(Colorate.Horizontal(Colors.blue_to_red, 'This email is already exists !.'))
                    sleep(2)
                    continue
                else:
                    print(Colorate.Horizontal(Colors.blue_to_red, 'FAILED.'))
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] Insert how much races you win.'))
                amount = IntPrompt.ask("[?] Amount")
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] Insert how much races you lose.'))
                amount = IntPrompt.ask("[?] Amount")
                console.print("[%] Changing your data: ", end=None)
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] Please Enter Account Detalis.'))
                ...
                if cpm.account_clone(to_email, to_password):
                    ...
                    print(Colorate.Horizontal(Colors.blue_to_red, 'FAILED.'))
                    print(Colorate.Horizontal(Colors.blue_to_red, '[!] THAT RECIEVER ACCOUNT IS GMAIL PASSWORD IS NOT VALID OR THAT ACCOUNT IS NOT REGISTERED.'))
                    sleep(2)
                    continue
            elif service == 27:
                console.print("[bold blue][!] Note[/bold blue]: original speed can not be restored!.")
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] ENTER CAR DETALIS'))
                car_id = IntPrompt.ask("[bold][?] CAR ID[/bold]")
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] ENTER STEERING ANGLE'))
                ...
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] ENTER CAR DETALIS'))
                car_id = IntPrompt.ask("[bold][?] CAR ID[/bold]")
                print(Colorate.Horizontal(Colors.blue_to_red, '[!] ENTER PERCENTAGE'))
